...
const CreateAccountPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-green-50 to-white flex items-center justify-center font-sans p-4">
      <div className="container mx-auto flex flex-col lg:flex-row max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden my-10">
        
        {/* Left Side - Branding */}
        <div className="w-full lg:w-1/2 p-8 md:p-12 bg-gradient-to-b from-teal-500 to-teal-600 text-white flex flex-col justify-center">
          <div className="hero-content text-center lg:text-left">
            <div className="text-2xl md:text-3xl font-bold mb-4">SynergySphere</div>
            ...
            <ul className="space-y-2 md:space-y-3 text-sm md:text-base">
              {[
                ...
                <li key={feature} className="flex items-center">
                  <svg className="w-5 h-5 md:w-6 md:h-6 mr-2 md:mr-3 text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-8 md:p-12 flex flex-col justify-center">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2 text-center lg:text-left">
            Create your account
          </h1>
          <p className="text-gray-500 mb-6 md:mb-8 text-center lg:text-left text-sm md:text-base">
